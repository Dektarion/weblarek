...
import { MainGallery } from './components/view/MainGallery.ts';
...
const header = new Header(events, DOM_ELEMENTS.header);
console.log(DOM_ELEMENTS.main);

const main = new MainGallery(DOM_ELEMENTS.main);
console.log(main);

const modal = new Modal(events, DOM_ELEMENTS.modal);
console.log(modal);

// DOM_ELEMENTS.main.replaceChildren(modal.render());
